...
import com.alibaba.jstorm.kafka.IPartitionConsumer.EmitState;
...
public class KafkaSpout implements IRichSpout {
	...
	public void nextTuple() {
		Collection<IPartitionConsumer> partitionConsumers = coordinator.getPartitionConsumers();
		for(IPartitionConsumer consumer: partitionConsumers) {
...
//			}
	...
	public void commitState() {
	    lastUpdateMs = System.currentTimeMillis();
		for(IPartitionConsumer consumer: coordinator.getPartitionConsumers()) {
	...
	public void ack(Object msgId) {
		...
		IPartitionConsumer consumer = coordinator.getConsumer(messageId.getPartition());
