...
public class KafkaSpoutConfig implements Serializable {
	...
	public String securityProtocol;// kafka认证协议
	public String saslMechanism;// kafka认证机制
	public String saslJaasConfig;// kafka认证配置
	...
	public void configure(Map conf) {
		...
		securityProtocol = getConfig("security.protocol", null);
		saslMechanism = getConfig("sasl.mechanism", null);
		saslJaasConfig = getConfig("sasl.jaas.config", null);
	}
